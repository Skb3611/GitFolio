...
const PersonalInfoCard = ({info}:{info:PersonalInformation}) => {
  ...
  <div className='flex flex-col justify-between gap-5 '>
    ...
    <div className='space-y-1'>
        <span className='flex item-start gap-1.5'><User/><AnimatedShinyText className='text-left w-full mx-0 text-sm md:text-base my-auto'>{info.full_name || "Name . . ."}</AnimatedShinyText></span>
        <span className='flex item-start gap-1.5'><AtSign /><AnimatedShinyText className='text-left w-full mx-0 text-sm md:text-base my-auto'>{info.username ||"Username..."}</AnimatedShinyText></span>
        <span className='flex item-start gap-1.5'><Mail /><AnimatedShinyText className='text-left w-full mx-0 text-sm md:text-base my-auto'>{info.email || "email..."}</AnimatedShinyText></span>
