...
const TechStackSection = () => {
  return (
    <div className='h-90 flex flex-col p-8 justify-start items-center'>
    <h2 className='w-full text-left text-2xl z-10 '>Built with Modern Web Technologies</h2>
    ...
    <div className="absolute -bottom-2 blur-[.7px] opacity-50 flex h-full w-full flex-col items-center justify-center overflow-hidden">
